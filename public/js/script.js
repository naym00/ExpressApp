function c_f_1()
{
    ...
    {
        let heigh_temperature = parseInt(document.getElementById("high-1").innerText.replace("oC", ""));
        let low_temperature = parseInt(document.getElementById("low-1").innerText.replace("oC", ""));

        let high_fahrenheit = (parseInt(((9*heigh_temperature)+160)/5)).toString();
        let low_fahrenheit = (parseInt(((9*low_temperature)+160)/5)).toString();
    ...
    {
        let heigh_temperature = parseInt(document.getElementById("high-1").innerText.replace("oF", ""));
        let low_temperature = parseInt(document.getElementById("low-1").innerText.replace("oF", ""));

        let high_celsius = (parseInt((5*(heigh_temperature - 32))/9)).toString();
        let low_celsius = (parseInt((5*(low_temperature - 32))/9)).toString();
...
function c_f_2()
{
    ...
    if (str_from_btn.localeCompare("Convert to Fahrenheit") == 0)
    {
        let heigh_temperature = parseInt(document.getElementById("high-2").innerText.replace("oC", ""));
        let low_temperature = parseInt(document.getElementById("low-2").innerText.replace("oC", ""));
    ...
    {
        let heigh_temperature = parseInt(document.getElementById("high-2").innerText.replace("oF", ""));
        let low_temperature = parseInt(document.getElementById("low-2").innerText.replace("oF", ""));
...
function c_f_3()
{
    ...
    if (str_from_btn.localeCompare("Convert to Fahrenheit") == 0)
    {
        let heigh_temperature = parseInt(document.getElementById("high-3").innerText.replace("oC", ""));
        let low_temperature = parseInt(document.getElementById("low-3").innerText.replace("oC", ""));
    ...
    {
        let heigh_temperature = parseInt(document.getElementById("high-3").innerText.replace("oF", ""));
        let low_temperature = parseInt(document.getElementById("low-3").innerText.replace("oF", ""));
...
function c_f_4()
{
    ...
    if (str_from_btn.localeCompare("Convert to Fahrenheit") == 0)
    {
        let heigh_temperature = parseInt(document.getElementById("high-4").innerText.replace("oC", ""));
        let low_temperature = parseInt(document.getElementById("low-4").innerText.replace("oC", ""));
    ...
    {
        let heigh_temperature = parseInt(document.getElementById("high-4").innerText.replace("oF", ""));
        let low_temperature = parseInt(document.getElementById("low-4").innerText.replace("oF", ""));
